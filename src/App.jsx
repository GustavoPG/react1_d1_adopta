    ...
    <>
      ...
      <div className='container'>
        <div className='row justify-content-center gap-5'>
          <MyCard myCardSrc="./src/assets/images/1.jpg"
            myCardName="Bolt"
          ...
          <MyCard myCardSrc="./src/assets/images/2.jpg"
            myCardName="Luna"
          ...
          <MyCard myCardSrc="./src/assets/images/3.jpg"
            myCardName="Rocky"
          ...
          <MyCard myCardSrc="./src/assets/images/4.jpg"
            myCardName="Coco"
          ...
          <MyCard myCardSrc="./src/assets/images/5.jpg"
            myCardName="Bella"
          ...
          <MyCard myCardSrc="./src/assets/images/6.jpg"
            myCardName="Max"
          ...
          <MyCard myCardSrc="./src/assets/images/7.jpg"
            myCardName="Daisy"
          ...
          <MyCard myCardSrc="./src/assets/images/8.jpg"
            myCardName="Simba"
          ...
          <MyCard myCardSrc="./src/assets/images/9.jpg"
            myCardName="Milo"
